...
<body>
  ...
  <img class="logo" src="https://raw.githubusercontent.com/jialii/the-littlest-jupyterhub/HEAD/docs/_static/images/logo/logo.png">
...
def _resolve_git_version(version):
    ...
    out = run_subprocess(
        [
            ...
            "--tags",
            "--refs",
            "https://github.com/jialii/the-littlest-jupyterhub.git",
        ]
    )
...
def main():
    ...
    if args.version or not bootstrap_pip_spec:
        ...
        bootstrap_pip_spec = (
            "git+https://github.com/jialii/the-littlest-jupyterhub.git@{}".format(
